...
std::uniform_real_distribution<float> distribution(0.00002f, 0.0004f);
//////////////////////////
...
void Window::onEvent(SDL_Event const &event) {
  ...
  if (event.type == SDL_KEYUP) {
    ...
    //   m_truckSpeed = 0.0f;
    if(event.key.keysym.sym == SDLK_SPACE) focoAzul = true;;
  }
}
...
void Window::onCreate() {
  ...
  gatoAmarelo.gato_position = glm::vec3(-1.5f, 0.0f, 0.0f);
  gatoBranco.gato_position = glm::vec3(0.0f, 0.0f, 0.0f);
  gatoAzul.gato_position = glm::vec3(1.5f, 0.0f, 0.0f);
...
void Window::onPaint() {
  ...
  // GATO BRANCO
  glm::mat4 model{1.0f};
  gatoBranco.gato_position.z += distribution(generator);
  ...
  // GATO AMARELO
  gatoAmarelo.gato_position.z += distribution(generator);
  model = glm::mat4(1.0);
  ...
  // GATO AZUL
  gatoAzul.gato_position.z += distribution(generator);     
  model = glm::mat4(1.0);
